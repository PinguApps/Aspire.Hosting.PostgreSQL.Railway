Feature: TypeScript AppHost fixture
  ...
  Scenario: Fixture consumes the generated Railway PostgreSQL TypeScript surface
    ...
    And the fixture calls the generated Railway PostgreSQL publish API with DTO options
    And the fixture consumes the generated Railway PostgreSQL outputs
