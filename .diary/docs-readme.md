...
- Current plan: Completed docs/sample audit; no open code changes.
...
- Key paths: README.md; docs/; samples/AppHostSnippets/RailwayPostgresAppHostSnippets.cs; samples/TypeScriptAppHost/
