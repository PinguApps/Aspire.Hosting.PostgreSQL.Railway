...
$solutionPath = Join-Path $repoRoot "Aspire.Hosting.PostgreSQL.Railway.slnx"
$fixtureSource = Join-Path $repoRoot "tests/Aspire.Hosting.PostgreSQL.Railway/Fixtures/TypeScriptAppHost"
...
$packageId = "PinguApps.Aspire.Hosting.PostgreSQL.Railway"
...
<configuration>
  ...
  <packageSourceMapping>
    <packageSource key="local-package-gate">
      <package pattern="PinguApps.Aspire.Hosting.PostgreSQL.Railway" />
    </packageSource>
